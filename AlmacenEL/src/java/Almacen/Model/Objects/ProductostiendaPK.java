...
public class ProductostiendaPK implements Serializable {
    ...
    public ProductostiendaPK(String codigoproducto, String codigoproductosbodega, String codigosalidaproducto, String codigoproductotienda) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProductostiendaPK)) {
            return false;
        }
        ProductostiendaPK other = (ProductostiendaPK) object;
    ...
    public String toString() {
        return "Almacen.Model.Objects.ProductostiendaPK[ codigoproducto=" + codigoproducto + ", codigoproductosbodega=" + codigoproductosbodega + ", codigosalidaproducto=" + codigosalidaproducto + ", codigoproductotienda=" + codigoproductotienda + " ]";
    }
