 ...
 */
@Embeddable
public class SalidaproductosPK implements Serializable {
    ...
    public SalidaproductosPK() {
    }

    public SalidaproductosPK(String codigoproducto, String codigoproductosbodega, String codigosalidaproducto) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SalidaproductosPK)) {
            return false;
        }
        SalidaproductosPK other = (SalidaproductosPK) object;
    ...
    public String toString() {
        return "Almacen.Model.Objects.SalidaproductosPK[ codigoproducto=" + codigoproducto + ", codigoproductosbodega=" + codigoproductosbodega + ", codigosalidaproducto=" + codigosalidaproducto + " ]";
    }
