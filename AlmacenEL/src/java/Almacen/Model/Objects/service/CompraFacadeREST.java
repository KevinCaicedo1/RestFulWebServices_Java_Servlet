 ...
 */
@Stateless
@Path("almacen.model.objects.compra")
public class CompraFacadeREST extends AbstractFacade<Compra> {
    ...
    private CompraPK getPrimaryKey(PathSegment pathSegment) {
         ...
         * URI path part is supposed to be in form of 'somePath;codigoproveedor=codigoproveedorValue;codigocompra=codigocompraValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        Almacen.Model.Objects.CompraPK key = new Almacen.Model.Objects.CompraPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        Almacen.Model.Objects.CompraPK key = getPrimaryKey(id);
